...
Analyzer factories provide one method: [`newInstance`](../cardscan-base/src/main/java/com/getbouncer/cardscan/base/Analyzer.kt#L25). This method creates a new copy of an analyzer.
